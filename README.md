...
There were 5 filters options created for the table on this webpage Fliter Search:
 ...
 - To filter by multiple fill in two or more filter options, then hit enter or click outside the box or click another box see examples below:
